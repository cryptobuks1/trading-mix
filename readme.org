...
:RESULTS:
[master d054961] New data added data/ohcl-2018-08-22-00:17:13.sqlite
 1 file changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 data/ohcl-2018-08-22-00:17:13.sqlite
:END:
...
#+BEGIN_SRC ipython
  ...
  def test_default_strategy(ohlc_12_hour_as_sql, caplog):
      ...
      assert buyMessage in caplog.text
      assert sellMessage not in caplog.text
...
========================================================== 1 passed, 38 deselected in 3.14 seconds ==========================================================
#+end_example
...
*** Get orders since
#+NAME: orders-since
#+HEADER: :session getorders
#+BEGIN_SRC ipython
  from trading.kraken import get_orders, connect

  k = connect()
  orders, _ = k.get_trades_history()
  orders.query('time>1534900208.0')['time'].tolist()
#+END_SRC
...
#+BEGIN_SRC sh :var mark="hest" debug=""

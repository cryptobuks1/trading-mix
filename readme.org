...
:RESULTS:
[master 57686a8] New data added data/ohcl-2018-09-09-23:18:09.sqlite
 1 file changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 data/ohcl-2018-09-09-23:18:09.sqlite
:END:
...
#+BEGIN_SRC ipython
  ...
  db = sqlite_connect('/home/kristian/projects/trading/data/ohcl-2018-09-04-07:33:05.sqlite')

  strategy, events = default_kraken_strategy(buy_fn=plot,
                                             sell_fn=plot,
                                             latest_order_epoc_fn=lambda: 0)
  strategy(db, offset=3600)
#+END_SRC

#+RESULTS: plot-simple-strategy
:RESULTS:
# Out[187]:
[[file:./obipy-resources/321554sn.png]]
:END:
**** Store on order
#+NAME: store-on-order
#+HEADER: :results raw drawer
...
#+BEGIN_SRC ipython
  ...
  for idx, order in orders.iterrows():
      colors = {'buy': '#ff0000',
                'sell': '#00ff00'}
      ax.axvline(x=datetime.fromtimestamp(order['tpime']),
                 color=colors[order['type']])
  plt.show()
#+END_SRC
...
:RESULTS:
# Out[3]:
[[file:./obipy-resources/10726zXI.png]]
:END:

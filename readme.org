...
#+BEGIN_SRC python :var sqlfile=ask-for-datafile
  from trading.data import window_generator, TradeCommand
  from trading.plot import axis_with_dates_x, plot_analysis
  ...
  plotter = partial(plot_analysis, ax)
  ...
  for data in window_generator(3600 * 5, 1800, **db):
      print("Hest")
      strategy(data)
#+END_SRC

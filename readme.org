...
:RESULTS:
[master 24e4fac] New data added data/ohcl-2018-08-29-23:19:29.sqlite
 2 files changed, 3 insertions(+), 1 deletion(-)
 create mode 100644 data/ohcl-2018-08-29-23:19:29.sqlite
:END:
...
#+BEGIN_SRC ipython
  ...
  strategy(db, direction="head", offset=3600)
#+END_SRC

#+RESULTS: plot-simple-strategy
:RESULTS:
# Out[6]:
[[file:./obipy-resources/25611nL.png]]
:END:

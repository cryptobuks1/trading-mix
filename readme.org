...
#+BEGIN_SRC python :var sqlfile=ask-for-datafile
  ...
  from trading.ui import update_ui
  from functools import partial
  from dev.order import simulation
  ...
  def plot_peak(data):
      data_analysis\
          .default_plots\
          .psl.set_data(as_dates(data['result']['xfit']),
                        data['result']['yfit'])
      data_analysis.fig.canvas.draw()
      data_analysis.fig.canvas.flush_events()
  ...
  def onNewPeak(peak_analysis):
      ...
      data_analysis\
          .default_plots\
          .psl.\
          set_data(as_dates(peak_analysis['xpeak']),
                   peak_analysis['ypeak'])
      data_analysis.fig.canvas.draw()
      data_analysis.fig.canvas.flush_events()
  ...
  def plot_data(data):
      ...
      update_graph(data_analysis.fig,
                   data_analysis.default_plots.ticks,
                   xd,
                   y)


  bind(data_analysis.events.data, plot_data)
  ...
  update_ui(data_analysis.window)
  data_analysis.run()
#+END_SRC

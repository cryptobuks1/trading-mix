...
:RESULTS:
[master e9cd083] New data added data/ohcl-2018-09-14-17:17:40.sqlite
 1 file changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 data/ohcl-2018-09-14-17:17:40.sqlite
:END:
...
#+BEGIN_SRC ipython :var sqlfile=ask-for-datafile
  ...
  strategy(db, offset=(3600 * 3)+600)
#+END_SRC

#+RESULTS: plot-simple-strategy
:RESULTS:
# Out[9]:
[[file:./obipy-resources/22757VAa.png]]
:END:
**** Store on order
#+NAME: store-on-order
#+HEADER: :results raw drawer
...
: /home/kristian/projects/trading/data/ohcl-2018-08-21-22:22:09.sqlite
